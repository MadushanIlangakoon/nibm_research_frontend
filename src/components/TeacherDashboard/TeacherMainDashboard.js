...
const TeacherMainDashboard = () => {
    ...
    const createCourse = async (e) => {
        ...
        try {
            ...
            const res = await axios.post(`${window.baseUrl}/api/courses/create-course`, {
                teacher_id: teacherRow.id,
                teacher_name: teacherRow.name, // corrected field
                                ...
                                <form onSubmit={createCourse} className="space-y-6">
                                    <div>
                                        <label htmlFor="subject"
                                               className="block text-gray-700 font-medium mb-2">Subject</label>
                                        <input
                                            id="subject"
                                            type="text"
                                    ...
                                    <div>
                                        <label htmlFor="title"
                                               className="block text-gray-700 font-medium mb-2">Title</label>
                                        <input
                                            id="title"
                                            type="text"
